...
fn example_matmul() {
    ...
    info_x.insert("address_label".to_string(), OperationInfo::String("X".to_string()));
    ...
    info_w.insert("address_label".to_string(), OperationInfo::String("W".to_string()));
    info_w.insert("NumRows".to_string(), OperationInfo::Int(64));
    info_w.insert("NumColumns".to_string(), OperationInfo::Int(64));
    tree.new_abstract_operation(AbstractOperation::TMatmul, vec![input], vec![output], Some(info_w));

    // Store output
    let mut info_y = HashMap::new();
    info_y.insert("address_label".to_string(), OperationInfo::String("Y".to_string()));
...
fn example_ffn_layer() {
    ...
    info_wg.insert("address_label".to_string(), OperationInfo::String("W_gate".to_string()));
    info_wg.insert("NumRows".to_string(), OperationInfo::Int(intermediate_dim as i64));
    info_wg.insert("NumColumns".to_string(), OperationInfo::Int(hidden_dim as i64));
    tree.new_abstract_operation(AbstractOperation::TMatmul, vec![x], vec![gate], Some(info_wg));

    // up = up_proj(x)
    let mut info_wu = HashMap::new();
    info_wu.insert("address_label".to_string(), OperationInfo::String("W_up".to_string()));
    info_wu.insert("NumRows".to_string(), OperationInfo::Int(intermediate_dim as i64));
    info_wu.insert("NumColumns".to_string(), OperationInfo::Int(hidden_dim as i64));
    ...
    tree.new_abstract_operation(AbstractOperation::Mul, vec![gate_silu, up], vec![intermediate], None);

    // output = down_proj(intermediate)
    let mut info_wd = HashMap::new();
    info_wd.insert("address_label".to_string(), OperationInfo::String("W_down".to_string()));
    info_wd.insert("NumRows".to_string(), OperationInfo::Int(hidden_dim as i64));
    info_wd.insert("NumColumns".to_string(), OperationInfo::Int(intermediate_dim as i64));
    tree.new_abstract_operation(AbstractOperation::TMatmul, vec![intermediate], vec![output], Some(info_wd));

    // Store output
    let mut info_out = HashMap::new();
    info_out.insert("address_label".to_string(), OperationInfo::String("Output".to_string()));
